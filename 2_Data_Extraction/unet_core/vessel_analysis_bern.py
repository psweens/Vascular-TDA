...
class VesselTree(object):
    ...
    def plot_vessels(self, metric=None, metric_scaling=100, cmap='viridis', width_metric='diameter', width_scaling=2,
...
class SkeletonTracker(object):
    ...
    def find_node(self, location):
        best_dist = np.inf
        best_node = None
        for n in list(self.current_component.graph.nodes()):
